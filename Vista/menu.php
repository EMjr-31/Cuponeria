        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<?=PATH?>/Vista/Principal/index.php">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?=PATH?>/Vista/Cupones/index.php">Cupones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?=PATH?>/Vista/Empresas/index.php">Empresas</a>
                </li>
                <li class="nav-item">
